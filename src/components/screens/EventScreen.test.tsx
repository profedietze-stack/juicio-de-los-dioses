...
// Every dilemma in the pool (ids 1-85) now has Ateneo content.
const ATENEO_COVERED_IDS = new Set(Array.from({ length: 85 }, (_, i) => i + 1));
...
describe('EventScreen Ateneo button', () => {
  ...
  // landing on one covered by Ateneo content — trivially the first one,
  // since the whole pool is covered, but kept generic in case future
  // dilemmas are added to the pool without content yet.
